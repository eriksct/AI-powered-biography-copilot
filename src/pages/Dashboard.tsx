...
import { BookOpen, Plus, MoreVertical, Trash2, User, LogOut } from 'lucide-react';
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {projects.map((project) => (
              <div
                key={project.id}
                className="group relative border border-border rounded-lg p-5 bg-panel hover:border-primary/30 transition-colors cursor-pointer"
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  {project.subject_name && (
                    <p className="text-sm text-muted-foreground">Sujet : {project.subject_name}</p>
                  )}
                  {project.description && (
